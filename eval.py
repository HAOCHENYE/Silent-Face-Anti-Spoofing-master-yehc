...
from src.anti_spoof_predict1 import AntiSpoofPredict,Detection
...
if __name__ == '__main__':
    ...
    # model = AntiSpoofPredict._load_model(model_path)
    # model.eval()
    run_test(AntiSpoofPredict, celebA_spoof_image_iter)
